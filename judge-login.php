<?php
/** 
 * Template Name: Judge Portal Login
 */
		...
		<div class="row">
			<div class="col-lg-8 offset-lg-2">
				<div class="user-login-form">
					<h2>Judge Portal</h2>
					<form id="login-form" name="login-form" action="<?php echo home_url(); ?>/judge-login/" method="post">
						<?php if (isset($loginError)) { echo '<div>' . $loginError . '</div>'; } ?>
						<div class="form-group">
							<label>Your Email address</label>
							<input type="email" name="username" id="username" class="form-control" placeholder="Enter Email Address" required="required">
						</div>
						<div class="form-group">
